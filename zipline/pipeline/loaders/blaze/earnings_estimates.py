...
from zipline.pipeline.loaders import EarningsEstimatesLoader
from .events import BlazeEventsLoader


class BlazeEarningsEstimatesLoader(BlazeEventsLoader):
    """A pipeline loader for the ``EarningsEstimates`` dataset that loads
    ...
    concrete_loader = EarningsEstimatesLoader
    default_dataset = EarningsEstimates
