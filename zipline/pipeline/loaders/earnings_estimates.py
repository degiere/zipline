"""
Reference implementation for EarningsEstimates loaders.
"""

from ..data import EarningsEstimates
...
class EarningsEstimatesLoader(EventsLoader):
    ...
    def __init__(self, all_dates, events_by_sid,
                 ...
                 dataset=EarningsEstimates):
        super(EarningsEstimatesLoader, self).__init__(
